...
df = pd.read_csv(os.path.join(root, "..", "data", "chembl33_sample_20k_with_crf_0.csv"), sep=",")
...
df.to_csv(os.path.join(root, "..", "results", "1_chembl_predictions_0.tsv"), sep="\t", index=False)